...
function _DownloadDataUrl(filenamePtr, dataUrlPtr) {
...
function _MotionSensorsWebGL_isRequestPermissionEverRequired() {
 if (typeof DeviceOrientationEvent.requestPermission === "function") return true; else return false;
}

function _MotionSensorsWebGL_registerDevicemotionEvent(devicemotion) {
...
function _MotionSensorsWebGL_registerDeviceorientationEvent(deviceorientation) {
...
function _MotionSensorsWebGL_requestPermission(userInteraction) {
 function requestPermission() {
  Module["MotionSensorsWebGL"].requestPermission().then(function(result) {
   return result;
  }, function(err) {
   console.error(err);
   return err;
  }).then(function(result) {
   Module["MotionSensorsWebGL"].requestPermissionClbks(JSON.stringify(Object.getOwnPropertyNames(Object.getPrototypeOf(result)).reduce(function(accumulator, currentValue) {
    return accumulator[currentValue] = result[currentValue], accumulator;
   }, {})));
  });
 }
 if (userInteraction) document.documentElement.addEventListener("pointerup", requestPermission, {
  once: true
 }); else requestPermission();
}

function _MotionSensorsWebGL_unregisterDevicemotionEvent() {
...
function _MotionSensorsWebGL_unregisterDeviceorientationEvent() {
...
function _OpenIframeJS() {
 try {
  if (typeof window.openIframe === "function") {
   window.openIframe();
   return;
  }
  var ov = document.getElementById("iframe-overlay");
  if (!ov) {
   ...
   closeBtn.innerText = "✖";
   closeBtn.style.cssText = `\n            position:absolute; top:20px; right:20px; padding:10px; border:none;\n            background:#e11; color:#fff; font-weight:700; cursor:pointer; z-index:10000;\n          `;
   closeBtn.onclick = function() {
    ov.style.display = "none";
   };
   var ifr = document.createElement("iframe");
   ifr.id = "info-frame";
   ifr.src = "https://ehabayman5dvr.github.io/ShoePOC/";
   ifr.allow = "camera; microphone; xr-spatial-tracking";
  ...
  console.warn("OpenIframeJS error:", e);
 }
}
...
var asmLibraryArg = {
 "DownloadDataUrl": _DownloadDataUrl,
 ...
 "MotionSensorsWebGL_isRequestPermissionEverRequired": _MotionSensorsWebGL_isRequestPermissionEverRequired,
 "MotionSensorsWebGL_registerDevicemotionEvent": _MotionSensorsWebGL_registerDevicemotionEvent,
 "MotionSensorsWebGL_registerDeviceorientationEvent": _MotionSensorsWebGL_registerDeviceorientationEvent,
 "MotionSensorsWebGL_requestPermission": _MotionSensorsWebGL_requestPermission,
 "MotionSensorsWebGL_unregisterDevicemotionEvent": _MotionSensorsWebGL_unregisterDevicemotionEvent,
 "MotionSensorsWebGL_unregisterDeviceorientationEvent": _MotionSensorsWebGL_unregisterDeviceorientationEvent,
 "OpenIframeJS": _OpenIframeJS,
...
var _MotionSensorsWebGL_requestPermissionClbks = Module["_MotionSensorsWebGL_requestPermissionClbks"] = createExportWrapper("MotionSensorsWebGL_requestPermissionClbks");
